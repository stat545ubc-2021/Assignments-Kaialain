...
#'
#' @param data The data that you will be using for this function.
#' @param x The variable in which you will be grouping the data by.
#' @param y The numerical variable of interest. This variable MUST be a numerical variable for this function to work.
...
#' @export
Data_overview <- function(data, x, y) {
